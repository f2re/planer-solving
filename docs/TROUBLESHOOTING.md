...
Документ относится к штатной установке «Борис по парам» в `/opt/planner-solving`. Имя `planner-solving` в командах и путях — стабильный технический идентификатор для совместимости существующих установок.
